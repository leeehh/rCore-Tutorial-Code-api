...
当前分支 `ch2-api` 用于第 2 章的独立实现。请按 [ch2 API 实验文档](./rcore-ch2-api.md) 实现系统调用与异常处理并在实验报告中分析你的实现与`ch2`参考实现的区别，请在本分支直接提交代码、说明文档及过程日志。

参考实现的阅读与调试见 [ch2 源代码分析与动态跟踪文档](../../blob/ch2/rcore-ch2-analyze.md)。
