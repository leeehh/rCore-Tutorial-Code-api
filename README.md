...
当前分支 `ch8-api` 用于第 8 章的独立实现。请按 [ch8 API 实验文档](./rcore-ch8-api.md) 实现线程同步与死锁检测模块并在实验报告中分析你的实现与`ch8`参考实现的区别，请在本分支直接提交代码、说明文档及过程日志。

参考实现的阅读与调试见 [ch8 源代码分析与动态跟踪文档](../../blob/ch8/rcore-ch8-analyze.md)。
