...
当前分支 `ch6-api` 用于第 6 章的独立实现。请按 [ch6 API 实验文档](./rcore-ch6-api.md) 实现文件管理模块并在实验报告中分析你的实现与`ch6`参考实现的区别，请在本分支直接提交代码、说明文档及过程日志。

参考实现的阅读与调试见 [ch6 源代码分析与动态跟踪文档](../../blob/ch6/rcore-ch6-analyze.md)。
