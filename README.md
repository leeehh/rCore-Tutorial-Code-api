...
整体实验安排见 [main 分支 README](../../blob/main/README.md)。

当前分支 `ch3` 提供第 3 章源代码，用于静态分析、跟踪分析和撰写实验报告。若选择本章进行独立实现，请使用 [`ch3-api`](../../tree/ch3-api) 分支，并阅读 [ch3 API 实验文档](../../blob/ch3-api/rcore-ch3-api.md)。
