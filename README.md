...
当前分支 `ch5-api` 用于第 5 章的独立实现。请按 [ch5 API 实验文档](./rcore-ch5-api.md) 实现进程管理与调度模块并在实验报告中分析你的实现与`ch5`参考实现的区别，请在本分支直接提交代码、说明文档及过程日志。

参考实现的阅读与调试见 [ch5 源代码分析与动态跟踪文档](../../blob/ch5/rcore-ch5-analyze.md)。
